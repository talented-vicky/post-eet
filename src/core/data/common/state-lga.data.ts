const stateLgaData: Record<string, string[]> = {
    'Abia': [
    ...
    'Adamawa': [
        'Demsa', 'Fufure', 'Ganye', 'Guyuk', 'Girei', 'Gombi', 'Hong', 'Jada',
    ...
    'Akwa Ibom': [
        ...
        'Ibeno', 'Ibesikpo Asutan', 'Ibiono-Ibom', 'Ika', 'Ikono', 'Ikot Abasi (village)',
    ...
    'Ebonyi': [
        "Abakaliki", "Afikpo", "Edda", "Ebonyi", "Ezza North", "Ezza South",
    ...
    'Kebbi': [
        "Aleiro", "Arewa", "Argungu", "Augie", "Bagudo", "Birnin Kebbi", "Bunza",
        "Dandi", "Fakai", "Gwandu", "Jega", "Kalgo"
    ],
    'Kogi': [
        "Adavi", "Ajaokuta", "Ankpa", "Bassa", "Dekina", "Ibaji", "Idah",
        "Igalamela-Odolu", "Kabba/Bunu", "Mopa-Muro", "Ijumu", "Yagba West",
        "Yagba East", "Okene", "Okehi", "Lokoja", "Isanlu", "Olamaboro", "Omala"
    ],
    'Kwara': [
    ...
    'Sokoto': [
        ...
        "Silame", "Sokoto North", "Sokoto South", "Tambuwal", "Tangaza", "Tureta", "Wamako",
        "Wurno", "Yabo"
    ],
    'Taraba': [
